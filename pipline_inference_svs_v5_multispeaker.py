...
from transformer_melody.inference import genarate_melody, getmodel
...
lyric2note, lyric2duration, lyric_dictionary, note_dictionary = getmodel(device)
...
def syn_music(lyrics, singer_id=0):
    ...
    for k, lyrics in enumerate(lyrics_list):
        lyrics, midis, durations = genarate_melody(lyric2note, lyric2duration, lyric_dictionary, note_dictionary, lyrics, device, k, previous_input)
        print(lyrics)
        print(midis)
        print(durations)
        if k > 0:
