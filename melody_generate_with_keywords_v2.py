...
from Lyric_generator_t5.generator import setup_lyric
...
def syn_music(keyword):
    lyrics = generate_lyric(keyword, lyric_model)
    print(lyrics)
    ...
    for i, lyrics in enumerate(lyrics_list):
        ...
        lyrics, midis, durations = generate_melody_mse(lyric2note, lyric2duration, lyric_dictionary, note_dictionary, lyrics, device,i, previous_input)
